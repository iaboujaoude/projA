...
{
        // TODO
        // replace the return statement with a correct implementation


        BankAccount *output_account = new BankAccount;

        output_account->owner = owner;
        output_account->accountNumber = accountNum;
        output_account->balance = balanceDollars + (0.01 * balanceCents);
        output_account->interestRate = interestRate / 100;
...
void BankAccount_destroy(BankAccount **accountpp)
{
        ...
        // You can save this for later if you're short of time
...
void BankAccount_deposit(BankAccount *accountp, int dollars, int cents)
{
        // TODO
        // Complete this function
        int total = dollars + (0.01 * cents);

        accountp->balance += total;
}
