...
void HashTable::insert(string key, Datum new_datum) {
    ...
    // if (get_lowercase(key) == "zebra") {
    //     WordInstance newS;
    //     newS.insert(new_datum);
    //     cout << "key adding is: " << key;
    //     cout << endl;
    //     cout << "contains bucket is: " << containsBucket(get_lowercase(key)) << endl;
    //     cout << endl;
    //     cout << "single datum: ";
    //     newS.print_datum(new_datum, cout);
    //     cout << endl;
    //     //cout << endl;

    //     cout << "-----key vision : ------" << endl;

    //     for (unsigned int j = 0; j < hashTable[get_index(get_lowercase(key))].bucket_vector.size(); j++) {
    //         if (get_lowercase(key) == hashTable[get_index(get_lowercase(key))].bucket_vector.at(j).return_name()) {
    //             cout << "Key is: " << hashTable[get_index(get_lowercase(key))].bucket_vector.at(j).return_name() << endl;
    //             for (int k = 0; k < hashTable[get_index(get_lowercase(key))].bucket_vector.at(j).get_size(); k++) {
    //                 cout << "Key instance: " << hashTable[get_index(get_lowercase(key))].bucket_vector.at(j).word_list[k].key << endl;
    //             }
    //         }
    ...
    //     cout << "----Ended insert----" << endl << endl << endl;
 ...
 *    Effects: None
 */
void HashTable::print_at_caseInSen(string key, ostream &out, vector<string>& lines, vector<string>& paths) {
    //cout << "in insensitive print hash\n";
    if (not containsBucket(key)) {
        return;
    }
    ...
    //     if (hashTable[index].bucket_vector.at(i).return_name() == 
    //         get_lowercase(key)) {
    //         hashTable[index].bucket_vector.at(i).print_list(out, lines, paths);
    //     }
    // }
 ...
 *    Effects: None
 */
void HashTable::print_at_caseSen(string key, ostream &out, vector<string>& lines, vector<string>& paths) {
...
// void HashTable::find_you() {
//     for (int i = 0; i < currentTableSize; i++) {
//         for (unsigned int j = 0; j < hashTable[i].bucket_vector.size(); j++) {
//             if (hashTable[i].bucket_vector[j].return_name() == "you") {
//                 cout << "Hi, you is at the index: " << i << " in bucket: \n" << j << endl;
//             }
//         }
//     }
// }

// WordList HashTable::something_you() {
//     return hashTable[29116].bucket_vector[0];
// }