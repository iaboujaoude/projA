...
int main()
{
    ...
    Datum new_datum = list.make_datum("/ewesto03/cs15/proj3", 3, "cool cool 
                                      cool cool cool, cool", 2, false);
    Datum new_datum1 = list.make_datum("/ewesto03/cs15/proj3/test", 37, 
                                       "this sucks", 1, true);
    Datum new_datum2 = list.make_datum("/ewesto03/cs15", 97, "these acting 
                                        like they tough", 3, true);
