...
int main()
{
    ...
    Datum new_datum = new_instance.make_datum("/ewesto03/cs15/proj3", 3, "cool cool cool cool cool, cool", 2, false);
    Datum new_datum1 = new_instance.make_datum("/ewesto03/cs15/proj3/test", 37, "this sucks", 1, true);
    Datum new_datum2 = new_instance.make_datum("/ewesto03/cs15", 97, "these acting like they tough", 3, true);
    Datum new_datum3 = new_instance.make_datum("/ewesto03/cs15", 156, "no", 4, false);
