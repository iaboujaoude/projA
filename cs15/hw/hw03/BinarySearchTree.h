...
public:
        ...
        //Testing helper function to delete
...
private:
        ...
        Node *create_node(int data) const;
        bool isEmpty() const;
        void deleteRoot();
        void removeWithTwo(Node *node, Node *previous);
        Node *get_par(Node *parent, Node *child);

        //Helper to delete:

        // void print_info(Node *node) const;
};
