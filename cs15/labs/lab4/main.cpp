...
int main() {
    string songs[10] = {
        "Dynamite", "Laugh Now Cry Later", "Rockstar",      "Blinding Lights",
...
void testStack(string songs[], int numSongs) {
    ...
    Stack myStack;
    cout << myStack.toString() << endl; // Should print an empty stack
    ...
    cout << myStack.toString() << endl; // Be sure all songs are there
